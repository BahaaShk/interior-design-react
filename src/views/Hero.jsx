...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.6} direction='down' padding fullWidth>
      ...
      <FadeIn delay={0.2} direction= 'up' padding fullWidth>
          ...
          <input type="text" className="rounded-full w-full pl-6 pr-[68px] py-4 bg-primary outline-none text-white placeholder-white text-base xs:text-lg" placeholder="Search" />
          <img src= {searchIcon} alt="search" className="absolute top-2/4 -translate-y-2/4 right-3 h-11 w-11 cursor-pointer" />
          </div>
      </FadeIn>
